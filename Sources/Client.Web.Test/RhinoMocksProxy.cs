...
namespace Client.Web.Test
{
    ...
    /// HAL: This class has been copied from MvcContrib assembly and changed to public from internal with small refactoring
    /// <typeparam name="T"></typeparam>
    public class RhinoMocksProxy<T> : IMockProxy<T>
    {
